...
export default function AboutPage() {
  ...
  return (
    <>
          ...
          <div className="grid gap-12 md:grid-cols-2">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground">
                Arrow Structures is a design-led Structural and Civil Engineering Consultancy based in India, 
                established in 2017. The company is driven by a passion for innovation, creativity, and 
                practical engineering solutions. Arrow Structures specializes in delivering superior and 
                cost-effective structural designs across all stages of building construction. From initial 
                concept and feasibility studies to complete design development, we ensure each project is 
      ...
      <section className="py-12 md:py-24">
        <div className="container">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-center">Meet Our Team</h2>
